...
echo "Welcome to the second part of the Ubuntu Cinnamon Conversion Script!"
...
echo "Cleaning Up..."
cd ..
sudo rm -rf create-usb
echo "The second part of the Ubuntu Cinnamon Conversion Script has finished..."
